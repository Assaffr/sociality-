<?php
	...
	class Login{
		...
		public function setSession($id){
			$_SESSION['user_id'] = $id;
			$resultSet = $this->_db->query("
					SELECT user_email, user_firstname, user_lastname, user_profile_picture, user_secret_picture FROM users, users_info WHERE users_info.user_id = $id AND users.user_id = $id
					");
