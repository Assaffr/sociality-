	...
	<body id="<?php echo $bodyId;?>">
			...
			<div id="topBar">
				...
				<?php if($page != "index.php"):?>
					<div id="topBarNav">
						<a href="profile.php" title="My profile"><strong><?php echo @$_SESSION["user_firstname"] . "&nbsp" . @$_SESSION["user_lastname"]?></strong><img alt="" src="pics/user.png"></a>
